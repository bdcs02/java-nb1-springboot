...
class UserApiController {
    ...
    PlayerModel playerPut(@RequestBody PlayerModel adatSzemely, @PathVariable int id) {
        return repo.findById(id)
                .map(a -> {
                    a.setBirthDate(a.getBirthDate());
                    a.setFirstName(a.getFirstName());
                    a.setIsForeign(a.getIsForeign());
                    a.setIsHungarian(a.getIsHungarian());
                    a.setLastName(a.getLastName());
                    a.setPlayerPost(a.getPlayerPost());
                    a.setPlayerRate(a.getPlayerRate());
                    a.setClubId(a.getClubId());
                    return repo.save(a);
                })
                .orElseGet(() -> {
